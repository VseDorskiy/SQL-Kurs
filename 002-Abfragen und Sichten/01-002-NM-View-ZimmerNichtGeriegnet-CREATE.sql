...
/****** Object:  View [dbo].[ZimmerNichtGereinigtDatum]    Script Date: 19.04.2023 09:32:36 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dbo].[ZimmerNichtGereinigtDatum]
AS
...
IF NOT EXISTS (SELECT * FROM sys.fn_listextendedproperty(N'MS_DiagramPane1' , N'SCHEMA',N'dbo', N'VIEW',N'ZimmerNichtGereinigtDatum', NULL,NULL))
...
IF NOT EXISTS (SELECT * FROM sys.fn_listextendedproperty(N'MS_DiagramPaneCount' , N'SCHEMA',N'dbo', N'VIEW',N'ZimmerNichtGereinigtDatum', NULL,NULL))
...
ELSE
BEGIN
	EXEC sys.sp_updateextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ZimmerNichtGereinigtDatum'
END
GO
